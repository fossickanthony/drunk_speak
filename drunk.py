...
st.title("SlurredSpeak Synthesizer")
...
original_prompt = "Hiiii hic there, frien'! What can Fossick translate for you today?"
target_language = "drunk speak"

message_placeholder = st.empty()
full_response = ""

original_text = st.text_area("English")
go = st.button("Transhlate")
